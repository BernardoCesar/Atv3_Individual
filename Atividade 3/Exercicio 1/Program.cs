	...
	class Program {
		static void Main(string[] args) {
			...
			for (int i = 0 ; i < imagens; i++){
				using (SKBitmap bitmapEntrada = SKBitmap.Decode("C:\\Users\\bernardo.figueiredo\\Atv3_Individual\\Atividade 3\\Exercicio 1\\Exercicio1_"+i+".png"),
				bitmapSaidaAritmetica = new SKBitmap(new SKImageInfo(bitmapEntrada.Width, bitmapEntrada.Height, SKColorType.Gray8))) {
					...
					using (FileStream stream = new FileStream("C:\\Users\\bernardo.figueiredo\\Atv3_Individual\\Atividade 3\\Exercicio 1\\Exercicio1_"+i+"_saida"+".png", FileMode.OpenOrCreate, FileAccess.Write)) {
